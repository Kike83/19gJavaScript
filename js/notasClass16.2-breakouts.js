...
//     let allUsers = usersFiltrados.reduce( (acc, users) => {
//         return acc += `
...
//       document.querySelector('.list-group').innerHTML = allUsers

//   })



//   const paintUsers = ( arrUsers ) => {
...
// revisamos algunos comentarios, Francisco lo resolvió

// Noemí por chat de zoom, para mí
// terminar de cuadrar --> no lo pude ver en Chrome
